...
class AddressApi {
  ...
  Future<AddressModel> create(Map<String, dynamic> body) {
    return _guarded(() async {
      final result =
          await HttpManager.instance.post<ResultModel<AddressModel>>(
        '/api/v1/user/addresses',
        data: body,
        converter: (json) => ResultModel.object(
          json as Map<String, dynamic>,
  ...
  Future<AddressModel> update(int addressId, Map<String, dynamic> body) {
    return _guarded(() async {
      final result =
          await HttpManager.instance.patch<ResultModel<AddressModel>>(
  ...
  Future<AddressModel> setDefault(int addressId) {
    return _guarded(() async {
      final result =
          await HttpManager.instance.post<ResultModel<AddressModel>>(
  ...
  Future<void> delete(int addressId) {
    return _guarded(() async {
