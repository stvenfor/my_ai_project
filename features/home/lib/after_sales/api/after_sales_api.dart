...
class AfterSalesApi {
  ...
  Future<AfterSalesRecord> fetchDetail(int recordId) async {
    AuthHttpConfig.ensureInitialized();
    final result = await HttpManager.instance.get<ResultModel<AfterSalesRecord>>(
  ...
  Future<AfterSalesRecord> create({
    ...
    final result = await HttpManager.instance.post<ResultModel<AfterSalesRecord>>(
      '$_base/records',
      data: body,
      converter: (json) => ResultModel.fromJson(
        json as Map<String, dynamic>,
  ...
  Future<List<AfterSalesAppointment>> fetchPendingAppointments() async {
    AuthHttpConfig.ensureInitialized();
    final result = await HttpManager.instance.get<ResultModel<Map<String, dynamic>>>(
    ...
    return rawList
        .whereType<Map>()
        .map((e) => AfterSalesAppointment.fromJson(Map<String, dynamic>.from(e)))
        .toList();
  }
