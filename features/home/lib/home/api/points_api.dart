...
class PointsApi {
  ...
  Future<PointsStatus> fetchStatus() {
  ...
  Future<List<GrowthTask>> fetchTasks() {
    return _guarded(() async {
      final result =
          await HttpManager.instance.get<ResultModel<List<GrowthTask>>>(
        tasksPath,
        converter: (json) {
  ...
  Future<ClaimTaskResult> claimTask(String code) {
    return _guarded(() async {
      final result =
          await HttpManager.instance.post<ResultModel<ClaimTaskResult>>(
    ...
    return _guarded(() async {
      try {
        final result = await HttpManager.instance
            .get<ResultModel<ListData<PointsGiftItem>>>(
