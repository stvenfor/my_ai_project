...
class NewCarFollowApi {
  ...
  Future<NewCarFollowSummary> fetchSummary() {
    return _guarded(() async {
      final result =
          await HttpManager.instance.get<ResultModel<NewCarFollowSummary>>(
        '$_base/summary',
  ...
  Future<NewCarFollowFile> fetchDetail(String fileId) {
    return _guarded(() async {
      final result =
          await HttpManager.instance.get<ResultModel<NewCarFollowFile>>(
        '$_base/$fileId',
        converter: (json) => ResultModel.fromJson(
          json as Map<String, dynamic>,
  ...
  Future<NewCarFollowFile> create({
    ...
    return _guarded(() async {
      ...
      final result =
          await HttpManager.instance.post<ResultModel<NewCarFollowFile>>(
        _base,
        data: body,
        converter: (json) => ResultModel.fromJson(
          json as Map<String, dynamic>,
  ...
  Future<NewCarFollowFile> patch({
    ...
    return _guarded(() async {
      ...
      final result =
          await HttpManager.instance.patch<ResultModel<NewCarFollowFile>>(
        '$_base/$fileId',
        data: body,
        converter: (json) => ResultModel.fromJson(
          json as Map<String, dynamic>,
  ...
  Future<NewCarFollowLog> createLog({
    ...
    return _guarded(() async {
      ...
      final result =
          await HttpManager.instance.post<ResultModel<NewCarFollowLog>>(
        '$_base/$fileId/logs',
        data: data,
        converter: (json) => ResultModel.fromJson(
          json as Map<String, dynamic>,
