...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.sf.tf.router.NativeRouterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin wys_router, com.sf.tf.router.NativeRouterPlugin", e);
    }
  }
}
